...
export class UserEditPage {
  ...
  constructor(private userService: UserService, public router : Router, private route: ActivatedRoute, private notificationService:NotificationService, private roleService: RoleService) { }
  ...
  ngOnInit() {
    ...
    this.roleService.getRoles().subscribe((roleResponse) => {
      ...
      const roleIndex = this.formFields.findIndex((field) => field.name === 'role');
      if (roleIndex !== -1) {
